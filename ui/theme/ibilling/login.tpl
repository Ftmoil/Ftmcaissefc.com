...
<head>
    ...
    <link rel="shortcut icon" href="{$app_url}application/storage/icon/icone.ico">
    ...
    <div class="sign-in-wrapper">
        <div class="sign-in-inner">
            <div class="login-brand text-center">
                <img class="logo" src="{$app_url}application/storage/system/ftmlogo.png" alt="Logo">
