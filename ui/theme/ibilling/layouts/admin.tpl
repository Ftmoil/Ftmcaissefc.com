...
<head>
    ...
    {*<link rel="shortcut icon" href="{$app_url}application/storage/icon/icone.ico" type="image/x-icon" />*}

    <link rel="apple-touch-icon" sizes="180x180" href="{$app_url}application/storage/icon/icon.png">
    <link rel="icon" type="image/png" sizes="32x32" href="{$app_url}application/storage/icon/icon.png">
    <link rel="icon" type="image/png" sizes="16x16" href="{$app_url}application/storage/icon/icon.png">
        ...
        <div id="page-wrapper" class="gray-bg">
            <div class="row border-bottom">
                <nav class="navbar navbar-fixed-top white-bg" role="navigation" style="margin-bottom: 0">
                    ...
                    <img class="logo" style="max-height: 40px; width: auto;" src="{$app_url}application/storage/system/ftmlogo.png" alt="Logo">
                                ...
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <div class="form-material floating">
                                            ...
                                            <label for="ib_admin_notes">{$_L['bloc note']}</label>
                                        </div>
